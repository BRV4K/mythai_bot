                ...
                <div className='d-flex flex-wrap justify-content-between gap-4 buttons-cont'>
                    <div className="d-flex justify-content-between gap-3">
                        <Link to="/districtChange" className="d-flex position-relative main-btn-cont" onClick={() => {
                            ...
                            <img src='/img/rent_flat.png' className='w-100 h-100'/>
                        ...
                        <Link to="/districtChange" className="d-flex position-relative main-btn-cont" onClick={() => {
                            ...
                            <img src='/img/buy_flat.png' className='w-100 h-100'/>
                            <div className='main-btn w-100 h-100 position-absolute bottom-0'></div>
                    ...
                    <div className="d-flex justify-content-between gap-3">
                        <Link to="/districtChange" className="d-flex position-relative main-btn-cont" onClick={() => {
                            ...
                            <img src='/img/rent_house.png' className='w-100 h-100'/>
                            <div className='main-btn w-100 h-100 position-absolute bottom-0'></div>
                        ...
                        <Link to="/districtChange" className="d-flex position-relative main-btn-cont" onClick={() => {
                            ...
                            <img src='/img/buy_house.png' className='w-100 h-100'/>
                            <div className='main-btn w-100 h-100 position-absolute bottom-0'></div>
                    ...
                    <div className="d-flex justify-content-between gap-3">
                        <Link to="/districtChange" className="d-flex position-relative main-btn-cont" onClick={() => {
                            ...
                            <img src='/img/rent_villa.png' className='w-100 h-100'/>
                            <div className='main-btn w-100 h-100 position-absolute bottom-0'></div>
                        ...
                        <Link to="/districtChange" className="d-flex position-relative main-btn-cont" onClick={() => {
                            ...
                            <img src='/img/buy_villa.png' className='w-100 h-100'/>
                            <div className='main-btn w-100 h-100 position-absolute bottom-0'></div>
                    ...
                    <div className="d-flex justify-content-between gap-3">
                        <Link to="/districtChange" className="d-flex position-relative main-btn-cont" onClick={() => {
                            ...
                            <img src='/img/buy_ground.png' className='w-100 h-100'/>
                            <div className='main-btn w-100 h-100 position-absolute bottom-0'></div>
