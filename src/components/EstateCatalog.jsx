...
export default function EstateCatalog() {
    ...
    const filteredData = data.filter((estate) => {
        let apiDistrict = estate['Район'].toLowerCase();
        if (apiDistrict === 'панва') apiDistrict = 'вичит';
        ...
        return district.toLowerCase() === apiDistrict && estateType === apiEstateType && renameTransaction[orderType] === apiTransactionType;
    });
                    ...
                    {isLoading ? (
                        ...
                        <div className="catalog-cards-cont">
                            {filteredData.map((estate, key) => {
                                ...
                                const photoUrl = `${import.meta.env.VITE_PROXY_URL}/yandex-proxy?url=https://getfile.dokpub.com/yandex/get/${imgUrl}`;
                                return (
                                    <div
                                        key={key}
