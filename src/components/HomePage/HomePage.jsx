    ...
    return (
        <>
            ...
            <div className='app-container h-100 w-100 z-1'>
                ...
                <div className='footer-cont d-flex align-items-center justify-content-center mt-4'>
                    <p className='lh-1 m-0 footer-text'>Таиланд — это место, где мечты становятся реальностью.</p>
                </div>
            </div>
        </>
